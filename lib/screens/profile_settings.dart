...
extension _FriendListPageProfileTheme on _FriendListPageState {
  ...
  String _currentThemeKey() {
    final value = appMetaBox.get('theme');
    final key = value is String ? value : null;
  ...
  Future<void> _setTheme(String key) async {
    final themeKey = _themeKeys.contains(key) ? key : 'terminal';
    await appMetaBox.put('theme', themeKey);
    _refreshView();
  }
