                            ...
                            children: [
                              ...
                              Dismissible(
                                ...
                                child: InkWell(
                                  borderRadius: BorderRadius.circular(8),
                                  onTapDown: (_) =>
                                      setInnerState(() => pressed = true),
                                  onTapUp: (_) =>
                                      setInnerState(() => pressed = false),
                                  onTapCancel: () =>
                                      setInnerState(() => pressed = false),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _iconChoice('terminal', Icons.terminal, setDialogState),
                      SizedBox(width: 8),
                      _iconChoice('code', Icons.code, setDialogState),
                      SizedBox(width: 8),
                      _iconChoice('robot', Icons.smart_toy, setDialogState),
                      SizedBox(width: 8),
