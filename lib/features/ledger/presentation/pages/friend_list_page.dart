...
part '../../../settings/presentation/parts/profile_settings.dart';
...
class _FriendListPageState extends ConsumerState<FriendListPage>
  ...
  get appMetaBox => _preferencesRepository.box;
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          final amount =
                              ...
                              0;
                          if (amount <= 0) return;
                          await _ledgerRepository.addTransaction(
                            person,
                            LedgerTransaction(
  ...
  double getOverallTotal() {
    return _ledgerRepository.overallBalance;
  }
